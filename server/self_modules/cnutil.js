...
var bookId = '4526';
var startChapterName = '第四百六十八章 奥杜尔实验室';
...
// 入口函数
// 根据小说章节目录列表 进行抓取
function entry(bookListUrl, callback) {
...
var catchnovel = function(callback) {
    // 执行入口函数
    entry(bookListUrl, callback);
}

exports.catchnovel = catchnovel;
